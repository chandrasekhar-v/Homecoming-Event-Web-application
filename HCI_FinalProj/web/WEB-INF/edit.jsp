            ...
            <div style="border:1px solid #ccccff; align-items: center">
              ...
              <form class="form-horizontal" role="form"  onsubmit="return validation()" action="participantServlet">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="eventtitle" name="eventtitle" value="<%=request.getAttribute("eventtitle")%>" class="form-control" autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input  id="regdeadline" name="regdeadline" value="<%=request.getAttribute("regdeadline")%>" class="form-control">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" id="limit" name="limit" class="form-control" value="<%=request.getAttribute("limit")%>" >
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="eventlocation" name="eventlocation" value="<%=request.getAttribute("eventlocation")%>" class="form-control" autofocus>
                    ...
                    <div class="col-sm-5">
                        <input  id="competitiondate" name="competitiondate" value="<%=request.getAttribute("competitiondate")%>" class="form-control">
                        <span class="error" id="cdate"></span>
                    </div>
                </div>   
                <div class="form-group">                   
                   <div class="col-md-2 align-content: center">
                        <button type="submit" name="editdone" value="editdone" class="btn  btn-block" style="background-color: #006747; color: white">Edit Event</button>                </div>
                </div>
            </form> <!-- /form -->     
